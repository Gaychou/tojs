...
﻿; (function (win) {
    ...
    var transform = __class.extend({
        ...
        ctor: function (element) {
            ...
            element.alpha=element.scaleX = element.scaleY = element.scaleZ = 1;
            ...
            var observer = observable.watch(element, ["x", "y", "z", "scaleX", "scaleY", "scaleZ", "perspective", "rotateX", "rotateY", "rotateZ", "regX", "regY", "regZ", "alpha"]);

            this.element = element;
            var self = this;
            observer.propertyChangedHandler = function (prop) {
                if (prop == "alpha") {
                    self.element.style.opacity = element.alpha;
                }else{
